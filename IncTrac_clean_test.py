...
if __name__ == '__main__':
    ...
    imgPath = r'D:\TFAST\TEAMAero experiments\2023_06_12\2kHz_Ref P5_5-6Suc_4sec (Test 2)\*.png'
    ...
    NewFileDirectory = os.path.join(FileDirectory, "IncTrac_test")
