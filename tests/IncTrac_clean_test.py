...
if __name__ == '__main__':
    ...
    # imgPath = r'D:\TFAST\TEAMAero experiments\Reference Case data\2022_07_29_FastShileren\3kHz\*.png'
    # imgPath = r'D:\TFAST\TEAMAero experiments\Inlet valve (Second campaign)\Fully Open\2023-03-29_Sync_Oil_sch-fully open\Oil-sch test 8 - Final full covered\Schlieren\*.png'
    ...
    IncTrac.ShockPointsTracking(imgPath, scale_pixels = True,
                                ...
                                # Ref_x0 = [240, 690],Ref_y0 = 312,
                                # Ref_x0 = [54, 673],Ref_y0 = 521,
                                ...
                                # inclination_info = [100, (249, 0), (0, 429)],
                                # inclination_info = [100, (325, 0), (0, 577)],
                                ...
                                avg_txt_Yloc = 400,# fully open without 3rd plate
                                ...
                                osc_boundary = True,
                                store_n_files = 3,
                                # angle_interp_kind = 'CubicSpline',
                                # angle_interp_kind = 'PCHIP',
